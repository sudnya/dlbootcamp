...
class SoftmaxModel(Model):
  ...
  def add_model(self, input_data):
    ...
    ### YOUR CODE HERE
    #raise NotImplementedError
    print "n features" , self.config.n_features
    print "classes ", self.config.n_classes
    self.w = tf.Variable(tf.zeros([self.config.n_features, self.config.n_classes], dtype=tf.float32), name='W1')
